...
The `^0.13.0` constraint pulls v0.13.0 or any newer 0.13.x release. v0.13.0 adds opt-in external-ADC battery-voltage sensing, on top of v0.12.0's SoH NVS persistence, v0.11.0's Phase 8d SoH (on-device learning + wire v4 + Grafana panel), and Phases 8a–8c.
